...
const CampusTourCards = (props) => {
  return (
    <>
    <div class="rounded overflow-hidden shadow-lg shadow-green-400 border-solid border-white mx-auto sm:h-[9rem] sm:w-[18rem] lg:h-[16rem] lg:w-[26rem] md:h-[25rem] md:w-[44rem]">
