...
const CampusTourCards = (props) => {
  return (
    <div id='campustour'>
    <div class="rounded-2xl overflow-hidden shadow-lg shadow-green-400 border-solid hover:shadow-2xl hover:shadow-emerald-600 border-white mx-auto h-[14rem] w-[19rem] lg:h-[25rem] lg:w-[44rem]"> 
